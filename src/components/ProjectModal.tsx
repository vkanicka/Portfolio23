...
const ProjectModal = ({ url, reviews, githubRepoUrl, projectKey }: Props) => {
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 top-0 z-40 flex w-full flex-col items-center justify-center gap-6 bg-neutral-900 text-2xl text-my-lilac-400 opacity-0 hover:opacity-95">
